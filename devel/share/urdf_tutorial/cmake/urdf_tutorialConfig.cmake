...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /root/compare_SceneReplica/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /root/compare_SceneReplica/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /root/compare_SceneReplica/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/compare_SceneReplica/src/urdf_tutorial/${idir}'.  ${_report}")
    endif()
