...
if("TRUE" STREQUAL "TRUE")
  set(fetch_navigation_SOURCE_PREFIX /root/compare_SceneReplica/src/fetch_ros/fetch_navigation)
  set(fetch_navigation_DEVEL_PREFIX /root/compare_SceneReplica/devel)
  ...
  set(fetch_navigation_INSTALL_PREFIX /root/compare_SceneReplica/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fetch_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/compare_SceneReplica/src/fetch_ros/fetch_navigation/${idir}'.  ${_report}")
    endif()
