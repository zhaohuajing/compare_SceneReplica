...
"""autogenerated by genpy from posecnn_pytorch/Detection.msg. Do not edit."""
import codecs
import sys
...
class Detection(genpy.Message):
  _md5sum = "4be425bb4306d8ff3be362c5aaed7540"
  _type = "posecnn_pytorch/Detection"
...
float64 w
"""
  __slots__ = ['name','score','roi','pose']
  _slot_types = ['string','float32','posecnn_pytorch/BBox','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.score is None:
        self.score = 0.
      if self.roi is None:
        self.roi = posecnn_pytorch.msg.BBox()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_f4i3I().pack(_x.score, _x.roi.x1, _x.roi.y1, _x.roi.x2, _x.roi.y2, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.score, _x.roi.x1, _x.roi.y1, _x.roi.x2, _x.roi.y2, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_f4i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
